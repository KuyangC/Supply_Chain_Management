...
const roles: { value: UserRole; label: string; description: string }[] = [
  ...
  { value: "manager", label: "Manager", description: "Manage inventory and shipments" },
  { value: "operator", label: "Operator", description: "Update inventory and scan items" },
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-start space-x-2">
                  ...
                  <Label
                    htmlFor="terms"
                    className="text-sm font-normal text-gray-600 cursor-pointer leading-tight"
                  >
                    I agree to the{" "}
                    <Link
                      href="/terms"
